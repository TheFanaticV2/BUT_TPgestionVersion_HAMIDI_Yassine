...
public class MapLoader {
    ...
    public int[][] LoadTileMap(String mapName) throws IOException {
        ...
        try {
            FileReader fr = new FileReader("src/main/java/fr/iut/montreuil/S05_R08/tp01_GestionVersion/ressources/tilemaps/"+mapName+".csv");

            BufferedReader csvReader = new BufferedReader(fr);

            FileReader fr2 = new FileReader("src/main/java/fr/iut/montreuil/S05_R08/tp01_GestionVersion/ressources/tilemaps/"+mapName+".csv");
